...
export default {
  ...
  methods: {
    ...
    getProcDefRouteSet (data, callback) {
      this.$http.get(`/api/act/process/getProcDefBizRoute/${data.processDefinitionId}`).then(({ data: res }) => {
        if (res.code !== 0) {
    ...
    getProcDefBizRouteAndProcessInstance (params, callback) {
      this.$http.get(`/api/act/process/getProcDefBizRouteAndProcessInstance`, {
        params: params
      }).then(({ data: res }) => {
        if (res.code !== 0) {
          return this.$message.error(res.msg)
    ...
    getLatestProcDefRouteSet (procDefKey, callback) {
      this.$http.get(`/api/act/process/getLatestProcDefBizRoute`, {
        params: {
