...
export default {
  ...
  methods: {
    ...
    getCaptcha() {
      ...
      this.captchaPath = `${window.SITE_CONFIG["apiURL"]}/login/captcha?uuid=${this.dataForm.uuid}`;
    },
    // 表单提交
    dataFormSubmitHandle: debounce(
      function () {
        this.$refs["dataForm"].validate((valid) => {
          ...
          this.$http
            .post("/oauth/token", this.dataForm, {
              headers: {
            ...
            .then(({ data: res }) => {
              ...
              this.$store.commit("UPDATE_REFRESH", res.data.refresh_token);
